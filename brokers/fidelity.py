...
class Fidelity(Broker):
    ...
    def _change_order_type(self, actionType: ActionType):
    ...
    def _choose_option_symbol(self, sym: str):
    ...
    def _choose_option_action(self, action_type: ActionType):
    ...
    def _set_option_expiration(self, expiration_date: str):
    ...
    def _set_strike_price(self, strike):
    ...
    def _set_option_order_type(self):
    ...
    def _save_report(
        ...
        **kwargs,
        ...
        # self._add_report_to_file(program_submitted, program_executed, None, sym, ActionType.SELL,
    ...
    @staticmethod
    def _create_row(sym, action, strike=None, expiration=None, option_type: str = None):
        if not strike:  # if strike does not exists normal stock trade
            return pd.Series(
                [sym, action, None, None, None],
