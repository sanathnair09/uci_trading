...
from utils.report.report import ActionType, BrokerNames, OptionData, OptionType, OrderType, StockData
...
class Vanguard(Broker):
    def __init__(self, report_file, broker_name: BrokerNames, option_report_file=None):
        ...
        self._chrome_inst.open("https://personal.vanguard.com/us/TradeTicket?investmentType=OPTION")
    ...
    def login(self):
        ...
        login_btn = self._chrome_inst.find(By.XPATH, '//*[@id="username-password-submit-btn-1"]')
        login_btn.click()
        time.sleep(1)
    ...
    def _set_option_type(self, option_type: OptionType):
        if option_type == OptionType.CALL:
            self._chrome_inst.find(By.XPATH, '//*[@id="baseForm:callRadioButton"]').click()
        else:
            self._chrome_inst.find(By.XPATH, '//*[@id="baseForm:putRadioButton"]').click()
    ...
    def _save_report(self, sym: str, action_type: ActionType, program_submitted, program_executed,
                     pre_stock_data: StockData, post_stock_data: StockData, **kwargs):
        pass

    def _save_option_report(self, order: OptionOrder, action_type: ActionType, program_submitted,
                            program_executed, pre_stock_data: OptionData,
                            post_stock_data: OptionData, **kwargs):
        pass
